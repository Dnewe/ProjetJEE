...
<div class="container mt-5">
    ...
    <form action="${pageContext.request.contextPath}/result" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="assessment-name" name="assessment-name" value="${result.assessmentName}" required>
        </div>
        <br>
        <!-- Note -->
        <div class="mb-3">
            ...
            <input type="number" step="1" class="form-control" id="max-score" name="max-score" value="${result.maxScore}" required>
        ...
        <!-- Boutons -->
        <a href="${pageContext.request.contextPath}/result?action=studentDetails&course-id=${course.id}&student-id=${student.id}" class="btn btn-danger">Annuler</a>
