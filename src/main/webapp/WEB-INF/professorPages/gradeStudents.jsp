...
<div class="container mt-4">
    ...
    <form action="${pageContext.request.contextPath}/result" method="post">
        ...
        <input type="hidden" name="result-page" value="student?action=courseList&course-id=${course.id}">
        <input type="hidden" name="course-id" value="${course.id}">

        <!-- Nom de l'évaluation -->
        <div class="mb-3">
            <label for="assessment-name" class="form-label">Nom de l'évaluation</label>
            <input type="text" class="form-control" id="assessment-name" name="assessment-name" required>
        </div>
        <br>
        <!-- Note maximale -->
        <div class="mb-3">
            <label for="max-score" class="form-label">Note maximale</label>
            <input type="number" step="1" class="form-control" id="max-score" name="max-score" required>
        ...
        <!-- Boutons -->
        <a href="student?action=courseList&course-id=${course.id}" class="btn btn-danger">Annuler</a>
